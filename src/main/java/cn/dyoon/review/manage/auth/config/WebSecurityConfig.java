package cn.dyoon.review.manage.auth.config;

import cn.dyoon.review.manage.auth.filter.JwtAuthenticationTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                //所有 /login 的请求 都放行
                .antMatchers("/users/login", "/enterprises/registered",
                        "/enterprises/types", "/enterprises/streets").permitAll()
